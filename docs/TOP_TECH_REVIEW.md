...
| Siemens EDA / C++ and toolchain quality | The candidate has local Apple Clang Release/CTest, WASM parity, sanitizer, property, fuzz, and exact-source-export smoke evidence; exact push run `34807277532` also passed remote GCC/Clang. | Nightly sanitizer/fuzz, clean-room, and extended reliability conclusions remain pending. |
