...
- Current committed final-main CI/report checkpoint: `c65a85f622abc630fe2abbb5dac2e5124920b7bf`
- Current candidate evidence index: [`evidence/v1.0.1/README.md`](../evidence/v1.0.1/README.md)
...
| Siemens EDA / C++ and toolchain quality | The candidate has local Apple Clang Release/CTest, WASM parity, sanitizer, property, fuzz, and exact-source-export smoke evidence; final-main push run `34808993438` also passed remote GCC/Clang. | Nightly sanitizer/fuzz, clean-room, and extended reliability conclusions remain pending. |
